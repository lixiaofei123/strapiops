            ...
            <CCard class="mb-0">
              ...
              <CCollapse :show="accordion === 0">
                <CCardBody>
                  ...
                  on it squid single-referer coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred
  ...
  data () {
    return {
      ...
      text: `
        ...
        tempor, sunt aliqua put a bird on it squid single-referer coffee nulla
